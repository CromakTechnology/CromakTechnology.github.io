...
window.defaultTiles['grid-google'] = [
    { pos: 'pos-1', url: 'https://gemini.google.com/', bg: '#226f7a', img: 'lib/thumbs/gemini.png', title: 'Gemini' },
    ...
    { pos: 'pos-5', url: 'https://drive.google.com/', bg: '#0d4823', img: 'lib/thumbs/google-drive.png', title: 'Google Drive' },
    { pos: 'pos-6', url: 'https://google.com/', bg: '#007bff', img: 'lib/thumbs/google.png', title: 'Google' },
    ...
    { pos: 'pos-9', url: 'https://maps.google.com/', bg: '#5c820a', img: 'lib/thumbs/google-maps.png', title: 'Google Maps' },
    { pos: 'pos-10', url: 'https://mail.google.com/', bg: '#c4000f', img: 'lib/thumbs/google-gmail.png', title: 'Google Gmail' },
    { pos: 'pos-11', url: 'https://play.google.com/', bg: '#409da5', img: 'lib/thumbs/google-play.png', title: 'Google Play' },
    { pos: 'pos-12', url: 'https://support.google.com/', bg: '#f8bc1e', img: 'lib/thumbs/google-support.png', title: 'Google Suporte' }
];
